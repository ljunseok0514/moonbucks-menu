  ...
  $("#espresso-menu-name").addEventListener("keypress", (e) => {
    ...
    if (e.key === "Enter") {
      ...
      const menuItemTemplate = (espressMunuName) => {
        ...
        <span class="w-100 pl-2 menu-name">${espressMunuName}</span>
        <button
          type="button"
...
//TODO 메뉴 수정
// - [ ] 메뉴의 수정 버튼 클릭 이벤트를 받고, `prompt`창이 뜬다.
// - [ ] `prompt`에서 신규메뉴명을 입력 받고, 확인버튼을 누르면 메뉴가 수정된다.

//TODO 메뉴 삭제
// - [ ] 메뉴 삭제 버튼클릭 이벤트를 받고, 메뉴 삭제 `confirm` 창이 뜬다.
